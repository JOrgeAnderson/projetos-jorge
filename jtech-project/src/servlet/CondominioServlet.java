...
//			String cond = request.getParameter("cond");
			...
			if (acao.equalsIgnoreCase("listarcond")) {
				RequestDispatcher view = request.getRequestDispatcher("/administracaoservice.jsp");
